...
const items:[string,FantasyTarget,string][]=[['Stats','Stats','stats'],['Waffen','Kampf','waffen'],['Items','Inventar','items'],['Zauber','Zauber','zauber'],['Können','Übersicht','koennen'],['Story','Notizen','story']];
